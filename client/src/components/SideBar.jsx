...
function SideBar() {
  ...
  <div className="p-6"> {/* Add your desired padding here */}
    
    <div className="sidebar-section-title my-2 text-base uppercase font-bold">
      <Link to="/dashboard" className="sidebar-link flex items-center text-inherit no-underline">
    ...
    <div className="sidebar-section mt-5">
      ...
      <ul className="sidebar-nav">
        <li className="sidebar-item my-3">
          <Link to="/dashboard/today" className="sidebar-link flex items-center text-inherit no-underline">
            <FaChessPawn className="sidebar-icon" />
            Today
          </Link>
        </li>
        <li className="sidebar-item my-3">
          <Link to="/dashboard/week" className="sidebar-link flex items-center text-inherit no-underline">
            <FaChessKnight className="sidebar-icon" />
            This Week
          </Link>
        </li>
        <li className="sidebar-item my-3">
          <Link to="/dashboard/month" className="sidebar-link flex items-center text-inherit no-underline">
    ...
    <div className="sidebar-section">
      <div className="sidebar-section-title my-2 text-base uppercase font-bold">
        <Link to="/dashboard/categories" className="sidebar-link flex items-center text-inherit no-underline">
      ...
      <ul className="sidebar-nav">
        {isLoading ? (
          ...
          delayedCategories.map((category) => (
            <li key={category.id} className="sidebar-item my-3">
              <Link
    ...
    <div className="sidebar-section">
      <div className="sidebar-section-title my-2 text-base uppercase font-bold">
        <Link to="/dashboard/habits" className="sidebar-link flex items-center text-inherit no-underline">
          <MdEdit className="sidebar-icon" />
          Habits
        </Link>
      </div>
